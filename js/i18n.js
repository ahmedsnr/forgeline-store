...
const I18N = {
  ar: {
    ...
    "section.bestsellers.title": "الأكثر مبيعاً",
    "section.new.eyebrow": "آخر الإضافات",
    "section.new.title": "وصل حديثاً",
    "section.offers.eyebrow": "لفترة محدودة",
    "section.offers.title": "عروض حصرية",
    ...
    "cat.creatine": "كرياتين",
    "cat.vitamins": "فيتامينات ومعادن",
    ...
    "checkout.commune.ph": "اكتب البلدية باللغة العربية",
    "checkout.delivery": "نوع التوصيل",
    "checkout.home": "توصيل للمنزل",
    "checkout.office": "مكتب التوصيل",
    "checkout.notes": "ملاحظات (اختياري)",
    "checkout.payment": "طريقة الدفع",
    "checkout.cod": "الدفع عند الاستلام (نقداً)",
    "checkout.cod.desc": "تدفع المبلغ كاش عند استلام طلبك من المندوب",
    "checkout.summary": "ملخص الطلب",
    "checkout.delivery.fee": "رسوم التوصيل",
    ...
    "footer.copyright": "© 2026 أبو المساكين — جميع الحقوق محفوظة",
    "pdp.add": "أضف للسلة",
  ...
  fr: {
    ...
    "section.bestsellers.title": "Meilleures ventes",
    "section.new.eyebrow": "Dernières nouveautés",
    "section.new.title": "Nouveautés",
    "section.offers.eyebrow": "Pour une durée limitée",
    "section.offers.title": "Offres exclusives",
    ...
    "cat.creatine": "Créatine",
    "cat.vitamins": "Vitamines",
    ...
    "checkout.commune.ph": "Écrire la commune en arabe",
    "checkout.delivery": "Type de livraison",
    "checkout.home": "Livraison à domicile",
    "checkout.office": "Bureau de livraison",
    "checkout.notes": "Remarques (optionnel)",
    "checkout.payment": "Mode de paiement",
    "checkout.cod": "Paiement à la livraison (espèces)",
    "checkout.cod.desc": "Payez en espèces à la réception de votre commande",
    "checkout.summary": "Résumé de la commande",
    "checkout.delivery.fee": "Frais de livraison",
    ...
    "footer.copyright": "© 2026 Abou El Massakine — Tous droits réservés",
